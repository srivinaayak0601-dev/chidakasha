...
function VideoTimelineMockup() {
  ...
  return (
    <div className="w-full h-full flex flex-col p-3 bg-[#0a0a0c] rounded-xl overflow-hidden">
          ...
          <div className="flex items-center gap-1">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-[12px] font-medium flex items-center gap-1.5 transition-all ${activeTool === tab.id ? "bg-purple-600/20 text-purple-300 border border-purple-500/30" : "text-white/50 hover:text-white hover:bg-white/[0.06]"}`}
              >
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          {activeTool === "Video Edit" ? (
            ...
            <div className="min-h-full">
              ...
              <div className="relative flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
                ...
                <div className="animate-slide-up-delay-3 relative z-10 flex items-center gap-3 flex-wrap justify-center mb-6">
                  {["🎬 Video Editor", "🎨 Graphic Design", "📐 3D CAD"].map(badge => (
                    <span key={badge} className="px-4 py-1.5 bg-white/[0.06] border border-white/10 rounded-full text-[13px] text-white/70 font-medium">
                      {badge}
                    </span>
                  ))}
                </div>
                ...
                <div className="animate-slide-up-delay-4 relative z-10 flex items-center gap-3">
                  <button
                    onClick={() => setActiveTool("Video Edit")}
                    className="bg-[#8b3dff] hover:bg-[#7a35e0] text-white font-semibold px-6 py-3 rounded-xl flex items-center gap-2 transition-all active:scale-95 shadow-[0_0_24px_rgba(139,61,255,0.4)]"
                  >
              ...
              {/* ── DIVISION CARDS ── */}
              <div className="px-8 pb-16 max-w-[1200px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  {divisions.map(div => (
                    <div
                      key={div.id}
                      className={`card-glow group relative bg-gradient-to-b ${div.color} border ${div.border} rounded-2xl p-5 flex flex-col gap-4 transition-all duration-300 cursor-pointer`}
              ...
              <div id="waitlist" className="border-t border-white/[0.06] bg-[#0d0d0f] px-8 py-16 flex flex-col items-center text-center">
                ...
                {waitlistState === "done" ? (
                  <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-6 py-4 text-emerald-400 font-semibold">
                  ...
                  <form onSubmit={handleWaitlist} className="flex items-center gap-3 w-full max-w-md">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full bg-white/[0.06] border border-white/10 text-white text-[14px] rounded-xl pl-11 pr-4 py-3 outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/30 transition-all placeholder:text-white/30"
                      />
                    </div>
                    <button
                      type="submit"
                ...
                <p className="text-white/20 text-[12px] mt-4">No spam. Unsubscribe anytime.</p>
              </div>
